...
test("表示変更したCSSとJavaScriptは新しい版番号で読み込む", () => {
  assert.match(indexSource, /shiftbuilder\.css\?v=20260906-grid-1/);
  assert.match(indexSource, /main\.js\?v=20260906-grid-1/);
  assert.match(mainSource, /render-shift-table\.js\?v=20260906-grid-1/);
