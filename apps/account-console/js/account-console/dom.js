...
export const newUserBtn = document.getElementById("newUserBtn");

export const searchInput = document.getElementById("searchInput");

export const visibleCountText = document.getElementById("visibleCountText");
export const totalCountText = document.getElementById("totalCountText");
export const statusSummaryText = document.getElementById("statusSummaryText");
...
export const selectedUserIdText = document.getElementById("selectedUserIdText");
...
export const affiliationTypeInput = document.getElementById("affiliationTypeInput");
export const contractTypeInput = document.getElementById("contractTypeInput");
export const gradeRoleInput = document.getElementById("gradeRoleInput");
export const classificationMigrationHint = document.getElementById("classificationMigrationHint");
...
export const organizationAuthorityFieldset = document.getElementById("organizationAuthorityFieldset");
export const organizationLevelInput = document.getElementById("organizationLevelInput");
export const organizationVersionInput = document.getElementById("organizationVersionInput");
export const directManagerField = document.getElementById("directManagerField");
export const directManagerInput = document.getElementById("directManagerInput");
export const executiveReviewerField = document.getElementById("executiveReviewerField");
export const executiveReviewerInput = document.getElementById("executiveReviewerInput");
export const organizationReasonInput = document.getElementById("organizationReasonInput");
export const organizationAuthorityStatus = document.getElementById("organizationAuthorityStatus");
export const saveOrganizationBtn = document.getElementById("saveOrganizationBtn");
...
export const shiftbuilderPermissionInput = document.getElementById("shiftbuilderPermissionInput");
...
export const legacyPersonTypeText = document.getElementById("legacyPersonTypeText");
export const authUidText = document.getElementById("authUidText");
export const createdAtText = document.getElementById("createdAtText");
export const updatedAtText = document.getElementById("updatedAtText");
export const updatedByText = document.getElementById("updatedByText");

export const saveUserBtn = document.getElementById("saveUserBtn");
export const clearFormBtn = document.getElementById("clearFormBtn");

export const loadLogsBtn = document.getElementById("loadLogsBtn");
export const logsList = document.getElementById("logsList");
