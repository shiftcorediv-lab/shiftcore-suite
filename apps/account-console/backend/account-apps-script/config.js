...
const AUTHORIZATION_ENFORCEMENT_MODE_PROPERTY = "AUTHORIZATION_ENFORCEMENT_MODE";
const AUTHORIZATION_CUTOVER_ENABLED_PROPERTY = "AUTHORIZATION_CUTOVER_ENABLED";
const AUTHORIZATION_CUTOVER_ACTOR_ID_PROPERTY = "AUTHORIZATION_CUTOVER_ACTOR_ID";
const AUTHORIZATION_CUTOVER_REASON_PROPERTY = "AUTHORIZATION_CUTOVER_REASON";
const AUTHORIZATION_CUTOVER_MIGRATED_USER_IDS_PROPERTY = "AUTHORIZATION_CUTOVER_MIGRATED_USER_IDS";
const AUTHORIZATION_MIGRATION_ENABLED_PROPERTY = "AUTHORIZATION_MIGRATION_ENABLED";
const AUTHORIZATION_MIGRATION_ACTOR_ID_PROPERTY = "AUTHORIZATION_MIGRATION_ACTOR_ID";
const AUTHORIZATION_MIGRATION_REASON_PROPERTY = "AUTHORIZATION_MIGRATION_REASON";
const AUTHORIZATION_MIGRATION_APPROVED_PLAN_HASH_PROPERTY = "AUTHORIZATION_MIGRATION_APPROVED_PLAN_HASH";
...
const ATTENDANCE_APPROVAL_SERVICE_SECRET_PROPERTY = "ATTENDANCE_APPROVAL_SERVICE_SECRET";
